...
public class Innkeeper implements Serializable {
    ...
    @Lob
    @Column(name = "avatar_image_blob")
    private byte[] avatarImageBlob;

    @Column(name = "avatar_image_blob_content_type")
    private String avatarImageBlobContentType;

    @Lob
    @Type(type = "org.hibernate.type.TextType")
    @Column(name = "avatar_text_blob")
    private String avatarTextBlob;
    ...
    public byte[] getAvatarImageBlob() {
        return this.avatarImageBlob;
    }

    public Innkeeper avatarImageBlob(byte[] avatarImageBlob) {
        this.avatarImageBlob = avatarImageBlob;
        return this;
    }

    public void setAvatarImageBlob(byte[] avatarImageBlob) {
        this.avatarImageBlob = avatarImageBlob;
    }

    public String getAvatarImageBlobContentType() {
        return this.avatarImageBlobContentType;
    }

    public Innkeeper avatarImageBlobContentType(String avatarImageBlobContentType) {
        this.avatarImageBlobContentType = avatarImageBlobContentType;
        return this;
    }

    public void setAvatarImageBlobContentType(String avatarImageBlobContentType) {
        this.avatarImageBlobContentType = avatarImageBlobContentType;
    }

    public String getAvatarTextBlob() {
        return this.avatarTextBlob;
    }

    public Innkeeper avatarTextBlob(String avatarTextBlob) {
        this.avatarTextBlob = avatarTextBlob;
        return this;
    }

    public void setAvatarTextBlob(String avatarTextBlob) {
        this.avatarTextBlob = avatarTextBlob;
    }
    ...
    public String toString() {
        return "Innkeeper{" +
            ...
            ", avatarImageBlob='" + getAvatarImageBlob() + "'" +
            ", avatarImageBlobContentType='" + getAvatarImageBlobContentType() + "'" +
            ", avatarTextBlob='" + getAvatarTextBlob() + "'" +
