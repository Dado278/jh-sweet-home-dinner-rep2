...
public class InnkeeperServiceImpl implements InnkeeperService {
    ...
    public InnkeeperServiceImpl(InnkeeperRepository innkeeperRepository) {
    ...
    public Innkeeper save(Innkeeper innkeeper) {
        ...
        return innkeeperRepository.save(innkeeper);
    }
        ...
        return innkeeperRepository
            ...
            .map(
                existingInnkeeper -> {
                    ...
                    if (innkeeper.getAvatarImageBlob() != null) {
                        existingInnkeeper.setAvatarImageBlob(innkeeper.getAvatarImageBlob());
                    }
                    if (innkeeper.getAvatarImageBlobContentType() != null) {
                        existingInnkeeper.setAvatarImageBlobContentType(innkeeper.getAvatarImageBlobContentType());
                    }
                    if (innkeeper.getAvatarTextBlob() != null) {
                        existingInnkeeper.setAvatarTextBlob(innkeeper.getAvatarTextBlob());
                    }
