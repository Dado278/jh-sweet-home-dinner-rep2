...
export class SharedDinnerService {
  ...
  protected convertDateFromClient(sharedDinner: ISharedDinner): ISharedDinner {
    return Object.assign({}, sharedDinner, {
      ...
      dinnerDate: sharedDinner.dinnerDate?.isValid() ? sharedDinner.dinnerDate.format(DATE_FORMAT) : undefined,
    });
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.dinnerDate = res.body.dinnerDate ? dayjs(res.body.dinnerDate) : undefined;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((sharedDinner: ISharedDinner) => {
        ...
        sharedDinner.dinnerDate = sharedDinner.dinnerDate ? dayjs(sharedDinner.dinnerDate) : undefined;
      });
    }
    return res;
  }
